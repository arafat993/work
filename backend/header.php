            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class='bx bxs-user bx-tada' style='color:#8d1672' ></i>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-layouts">Social</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="social.php">Add New Social</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="bx bx-user"></i>
                                <span key="t-layouts">My Resume</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="resume.php">Add New Resume</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="bx bx-user"></i>
                                <span key="t-layouts">My Service</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="service.php">Add New service</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="customer.php">Add New Customer</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-layouts">How I Work</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="work.php">Add New Work</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-layouts">Skills</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="skills.php">Add New Skills</a></li>
                            </ul>
                        </li>
                </div>
                <!-- Sidebar -->
